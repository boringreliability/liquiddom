...
## What Comes Next
- FreeDrop **rendering** follow-up: extend `PhantomObserver.render()` to iterate `dropletIds` (today droplets exist in WASM but aren't drawn to canvas)
- W44 (impulse-triggered droplet spawning) + W46 (gravity) — both unlocked by W43+W45
