...
- W36 (render abstraction) DONE — W37 (WebGPU pipeline scaffolding) unblocked.
- Tag `v0.2.0-rc.0` whenever publish is desired (W51 pipeline ready)
- WebGPU rendering chain: W37 → W38 (SDF) → W39 (metaballs) → W40 (refraction). Visual payoff starts at W38.
