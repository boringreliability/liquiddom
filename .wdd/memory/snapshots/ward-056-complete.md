...
## What Comes Next
- W46 (gravity) — final FreeDrop ward; extends `FreeParticle::integrate` with `velocity += gravity * dt`. Now visually verifiable after W56.
- Tag `v0.2.0-rc.0` whenever publish is desired (W51 pipeline ready)
- W55 (scroll snap), W36 (renderer abstraction → WebGPU), examples/vue (DX)
