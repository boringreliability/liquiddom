...
export class PhantomObserver {
    ...
    setViews(entityView, particleView, newCapacity) {
    ...
    observe(el, liquidType) {
        ...
        if (id >= this._capacity) {
            throw new Error(`PhantomObserver capacity exceeded: ${this._capacity} elements max`);
        }
